Shader "Exercises/PBS/Fresnel"
{
	Properties
	{
		_F0("Fresnel Scale F0",Range(0,1)) = 0.5
			...
			Pass
			{
				...
				fixed4 frag(v2f i) : SV_Target
				{
					...
					fixed3 specular = 0;
						...
						//Fresnel coefficient
						fresnel = _F0 + (1 - _F0) * pow(1 - dot(h, worldLight), 5);//_F0 is 0.5 or above for metal
						...
						specular = fresnel * Dm * Gm / (4 * ndotl * ndotv) * ndotl * _LightColor0.rgb;
					#endif
