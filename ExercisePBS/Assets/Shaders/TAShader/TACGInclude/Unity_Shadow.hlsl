/************************************************************
 *
 * 对 SRP 中 Shadows.hlsl 进行了简化和修改
 *
 ************************************************************/

#ifndef __UNITY_SHADOW_INCLUDED__
#define __UNITY_SHADOW_INCLUDED__
...
#if defined(_IS_SHADOW_ENABLED) && defined(_UNIQUE_CHAR_SHADOW)
